...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "aGTM Device and Page Info",
  "brand": {
    "id": "brand_dummy",
    "displayName": "aGTM",
  ...
  "description": "Send Infos about the current device and page with an event.\nLike browser, bot-detection, how many words contains the page, what is the page title or the canonical tag, ...",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    "type": "CHECKBOX",
    "name": "countWords",
    "checkboxText": "Count how many words the current page contains",
    "simpleValueType": true
  },
  {
    "type": "CHECKBOX",
    "name": "countImages",
    "checkboxText": "Count how many images the current page contains",
    "simpleValueType": true
  },
  {
    "type": "GROUP",
    ...
    "subParams": [
      {
        "type": "CHECKBOX",
        "name": "useBotTest",
        "checkboxText": "Try to find out, whether user is a Bot",
        "simpleValueType": true
      }
    ]
  },
...
o.c.useBotTest = typeof data.useBotTest=='boolean' ? data.useBotTest : false;
...
if (typeof o.d.dnt!='boolean') o.d.dnt = o.f.getDNT();
...
o.f.checkExecutionTiming = function() {
  ...
  e.js_ex_time = o.d.js_ex_time = endTime - o.d.startTime;
...
o.f.handleUserInteraction = function() {
  if (templateStorage.getItem('useHumanTest')) {
    ...
    var o = { event:'human_check', human_detected:true };
    callInWindow('aGTM.f.fire', o);
...
o.f.getABpixel = function() {
  ...
  var o = { event:'adblock_check', adblock_detected:adBlock };
  callInWindow('aGTM.f.fire', o);
};
...
if (o.d.screen_width) e.screen_width = o.d.screen_width;
if (o.d.screen_height) e.screen_height = o.d.screen_height;
e.locale = callInWindow('aGTM.f.getVal','n','language') || '';
e.dnt = o.d.dnt;
e.cm = o.d.cm;
e.cm_str = JSON.stringify(o.d.cm);

// Get Cookie
if (o.c.useCookie) {
  var cv = callInWindow('aGTM.f.gc',o.c.cookieName);
  if (typeof cv=='string' && cv=='1') {
    o.c.useBotTest = false;
    o.c.useHumanTest = false;
...
// Human Test
if (o.c.useHumanTest && templateStorage.getItem('useHumanTest')) {
  o.f.handleEventListener('add');
}

// Push event function
if (o.c.useBotTest && o.d.device_type!='Bot') {
  o.d.startTime = callInWindow('aGTM.f.getVal','p','now') || 0;
  callInWindow('aGTM.f.timer', 'bottest_jsexct', o.f.checkExecutionTiming, {}, 500, 1);
} else {
  callInWindow('aGTM.f.fire', e);
  o.d.q.push(e);
}
...
Send Infos about the current device and page with an event.
Like browser, bot-detection, how many words contains the page, what is the page title or the canonical tag, ...
