...
yet, and the embedded copy of the library is v1.4.1 rather than the current one. Importing
the snapshot therefore gets you an older setup than the one documented here.
