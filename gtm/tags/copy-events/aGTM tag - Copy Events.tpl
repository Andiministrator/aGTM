...

{
  ...
  "description": "Event Handling for copying text\nRequires an aGTM integration of the GTM.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "eventname",
    "displayName": "Event Name, if a user copies a text",
    "simpleValueType": true,
    "defaultValue": "text_copy",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
  ...
  },
  {
    "type": "CHECKBOX",
    "name": "usecontact",
    "checkboxText": "Use a different Event Name, if the copied text is an email address or a phone number",
    "simpleValueType": true
  },
  {
    "type": "TEXT",
