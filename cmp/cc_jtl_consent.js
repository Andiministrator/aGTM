 ...
 * @type: JTL Shop Consent Banner (ws5)
 * @version 1.0
 * @lastupdate 14.12.2025 by Andi Petzoldt <andi@petzoldt.net>
...
aGTM.f.consent_check = function (action) {
  ...
  var json_obj = JSON.parse(ls_json);
  if (typeof json_obj!='object' || !json_obj || typeof json_obj.settings!='object' || !json_obj.settings) return false;
  var services_obj = json_obj.settings;
  // Get Services
  var services = [];
